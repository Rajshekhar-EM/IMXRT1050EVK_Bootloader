...
**********************************************************************
----------------------------------------------------------------------
File        : ID_SCREEN_ENGFUELRATE_POPUP.c
Purpose     : Generated file do NOT edit!
---------------------------END-OF-HEADER------------------------------
*/

#include "Resource.h"
#include "ID_SCREEN_ENGFUELRATE_POPUP.h"
...
static APPW_CREATE_ITEM _aCreate[] = {
  ...
  { WM_OBJECT_MULTIEDIT_Create,
    ID_MULTIEDIT_00, ID_SCREEN_ENGFUELRATE_POPUP,
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_00, ID_SCREEN_ENGFUELRATE_POPUP,
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_ENGINE_FUEL_RATE, ID_SCREEN_ENGFUELRATE_POPUP,
    { { { DISPOSE_MODE_REL_PARENT, 44, 0, 0 },
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_01, ID_SCREEN_ENGFUELRATE_POPUP,
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_02, ID_SCREEN_ENGFUELRATE_POPUP,
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_03, ID_SCREEN_ENGFUELRATE_POPUP,
  ...
  { WM_OBJECT_TEXT_Create,
    ID_TEXT_04, ID_SCREEN_ENGFUELRATE_POPUP,
...
static const APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_TEXT_00,                  APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_58) } },
  { ID_TEXT_00,                  APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_30_Bold_EXT_AA4) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_COLOR,        { ARG_V(GUI_WHITE) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_ALIGNTEXT,    { ARG_V(GUI_ALIGN_RIGHT | GUI_ALIGN_VCENTER),
                                                               ARG_V(0),
                                                               ARG_V(0) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_BKCOLOR,      { ARG_V(GUI_TRANSPARENT) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_COLOR2,       { ARG_V(GUI_TRANSPARENT) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_DECMODE,      { ARG_V(6),
                                                               ARG_V(2),
                                                               ARG_V(0),
                                                               ARG_V(0) } },
  { ID_TEXT_ENGINE_FUEL_RATE,    APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_40_Bold_EXT_AA4) } },
  ...
  { ID_TEXT_01,                  APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_91) } },
...
static const APPW_ACTION_ITEM _aAction[] = {
  { ID_VAR_ENGFUEL_RATE,         WM_NOTIFICATION_VALUE_CHANGED,    ID_TEXT_ENGINE_FUEL_RATE,    APPW_JOB_SETVALUE,       ID_SCREEN_ENGFUELRATE_POPUP__WM_NOTIFICATION_VALUE_CHANGED__ID_TEXT_ENGINE_FUEL_RATE__APPW_JOB_SETVALUE,
    { ARG_V(0),
    }, 0, NULL
  },
};
...
*/
APPW_ROOT_INFO ID_SCREEN_ENGFUELRATE_POPUP_RootInfo = {
  ID_SCREEN_ENGFUELRATE_POPUP,
  _aCreate, GUI_COUNTOF(_aCreate),
  _aSetup,  GUI_COUNTOF(_aSetup),
  _aAction, GUI_COUNTOF(_aAction),
  cbID_SCREEN_ENGFUELRATE_POPUP,
  0
};
