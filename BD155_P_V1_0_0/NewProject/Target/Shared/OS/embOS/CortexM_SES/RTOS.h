...
#define OS_STOP_DEINIT            OS_ARMv7M_DeInit
...
*/
void OS_HeapLock     (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_HeapUnlock   (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_PrintfLock   (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_PrintfUnlock (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_ScanfLock    (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_ScanfUnlock  (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_DebugIOLock  (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_DebugIOUnlock(void) OS_CODE_SECTION_ATTRIBUTE;
