...
usb/device/source/ehci/%.o: ../usb/device/source/ehci/%.c usb/device/source/ehci/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-usb-2f-device-2f-source-2f-ehci

clean-usb-2f-device-2f-source-2f-ehci:
	-$(RM) ./usb/device/source/ehci/usb_device_ehci.d ./usb/device/source/ehci/usb_device_ehci.o

.PHONY: clean-usb-2f-device-2f-source-2f-ehci
