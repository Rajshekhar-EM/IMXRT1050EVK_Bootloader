...
source/crc/%.o: ../source/crc/%.c source/crc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-crc

clean-source-2f-crc:
	-$(RM) ./source/crc/crc16.d ./source/crc/crc16.o ./source/crc/crc32.d ./source/crc/crc32.o

.PHONY: clean-source-2f-crc
