...
C_SRCS += \
../source/drivers/trng/bl_trng.c 

C_DEPS += \
./source/drivers/trng/bl_trng.d 

OBJS += \
./source/drivers/trng/bl_trng.o 


# Each subdirectory must supply rules for building sources it contributes
source/drivers/trng/%.o: ../source/drivers/trng/%.c source/drivers/trng/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-trng

clean-source-2f-drivers-2f-trng:
	-$(RM) ./source/drivers/trng/bl_trng.d ./source/drivers/trng/bl_trng.o

.PHONY: clean-source-2f-drivers-2f-trng
