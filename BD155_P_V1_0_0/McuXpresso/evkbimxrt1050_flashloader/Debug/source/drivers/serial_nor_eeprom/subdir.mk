...
source/drivers/serial_nor_eeprom/%.o: ../source/drivers/serial_nor_eeprom/%.c source/drivers/serial_nor_eeprom/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-serial_nor_eeprom

clean-source-2f-drivers-2f-serial_nor_eeprom:
	-$(RM) ./source/drivers/serial_nor_eeprom/serial_nor_eeprom.d ./source/drivers/serial_nor_eeprom/serial_nor_eeprom.o

.PHONY: clean-source-2f-drivers-2f-serial_nor_eeprom
