...
source/drivers/semc_nand/%.o: ../source/drivers/semc_nand/%.c source/drivers/semc_nand/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-semc_nand

clean-source-2f-drivers-2f-semc_nand:
	-$(RM) ./source/drivers/semc_nand/semc_nand_flash.d ./source/drivers/semc_nand/semc_nand_flash.o

.PHONY: clean-source-2f-drivers-2f-semc_nand
