...
C_SRCS += \
../source/drivers/usdhc/bl_usdhc.c 

C_DEPS += \
./source/drivers/usdhc/bl_usdhc.d 

OBJS += \
./source/drivers/usdhc/bl_usdhc.o 


# Each subdirectory must supply rules for building sources it contributes
source/drivers/usdhc/%.o: ../source/drivers/usdhc/%.c source/drivers/usdhc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-usdhc

clean-source-2f-drivers-2f-usdhc:
	-$(RM) ./source/drivers/usdhc/bl_usdhc.d ./source/drivers/usdhc/bl_usdhc.o

.PHONY: clean-source-2f-drivers-2f-usdhc
