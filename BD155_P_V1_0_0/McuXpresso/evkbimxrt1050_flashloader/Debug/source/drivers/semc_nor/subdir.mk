...
source/drivers/semc_nor/%.o: ../source/drivers/semc_nor/%.c source/drivers/semc_nor/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-semc_nor

clean-source-2f-drivers-2f-semc_nor:
	-$(RM) ./source/drivers/semc_nor/semc_nor_flash.d ./source/drivers/semc_nor/semc_nor_flash.o

.PHONY: clean-source-2f-drivers-2f-semc_nor
