...
C_SRCS += \
../source/drivers/microseconds/microseconds_pit.c 

C_DEPS += \
./source/drivers/microseconds/microseconds_pit.d 

OBJS += \
./source/drivers/microseconds/microseconds_pit.o 


# Each subdirectory must supply rules for building sources it contributes
source/drivers/microseconds/%.o: ../source/drivers/microseconds/%.c source/drivers/microseconds/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-microseconds

clean-source-2f-drivers-2f-microseconds:
	-$(RM) ./source/drivers/microseconds/microseconds_pit.d ./source/drivers/microseconds/microseconds_pit.o

.PHONY: clean-source-2f-drivers-2f-microseconds
