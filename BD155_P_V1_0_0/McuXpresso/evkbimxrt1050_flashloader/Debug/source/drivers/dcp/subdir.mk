...
C_SRCS += \
../source/drivers/dcp/bl_dcp.c 

C_DEPS += \
./source/drivers/dcp/bl_dcp.d 

OBJS += \
./source/drivers/dcp/bl_dcp.o 


# Each subdirectory must supply rules for building sources it contributes
source/drivers/dcp/%.o: ../source/drivers/dcp/%.c source/drivers/dcp/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-dcp

clean-source-2f-drivers-2f-dcp:
	-$(RM) ./source/drivers/dcp/bl_dcp.d ./source/drivers/dcp/bl_dcp.o

.PHONY: clean-source-2f-drivers-2f-dcp
