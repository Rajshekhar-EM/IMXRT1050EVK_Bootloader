...
C_SRCS += \
../source/drivers/semc/bl_semc.c 

C_DEPS += \
./source/drivers/semc/bl_semc.d 

OBJS += \
./source/drivers/semc/bl_semc.o 


# Each subdirectory must supply rules for building sources it contributes
source/drivers/semc/%.o: ../source/drivers/semc/%.c source/drivers/semc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drivers-2f-semc

clean-source-2f-drivers-2f-semc:
	-$(RM) ./source/drivers/semc/bl_semc.d ./source/drivers/semc/bl_semc.o

.PHONY: clean-source-2f-drivers-2f-semc
