...
C_DEPS += \
./source/property/src/property_imx.d 

OBJS += \
./source/property/src/property_imx.o 


# Each subdirectory must supply rules for building sources it contributes
source/property/src/%.o: ../source/property/src/%.c source/property/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-property-2f-src

clean-source-2f-property-2f-src:
	-$(RM) ./source/property/src/property_imx.d ./source/property/src/property_imx.o

.PHONY: clean-source-2f-property-2f-src
