...
../source/utilities/src/fsl_assert.c \
../source/utilities/src/fsl_rtos_abstraction.c 

C_DEPS += \
./source/utilities/src/debug_util.d \
./source/utilities/src/fsl_assert.d \
./source/utilities/src/fsl_rtos_abstraction.d 

OBJS += \
./source/utilities/src/debug_util.o \
./source/utilities/src/fsl_assert.o \
./source/utilities/src/fsl_rtos_abstraction.o 


# Each subdirectory must supply rules for building sources it contributes
source/utilities/src/%.o: ../source/utilities/src/%.c source/utilities/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-utilities-2f-src

clean-source-2f-utilities-2f-src:
	-$(RM) ./source/utilities/src/debug_util.d ./source/utilities/src/debug_util.o ./source/utilities/src/fsl_assert.d ./source/utilities/src/fsl_assert.o ./source/utilities/src/fsl_rtos_abstraction.d ./source/utilities/src/fsl_rtos_abstraction.o

.PHONY: clean-source-2f-utilities-2f-src
