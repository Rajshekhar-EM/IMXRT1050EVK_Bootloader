...
*/
	...
	#define JUMP_ADDRESS  0x60082305//0x60002304 // Example address, replace with your desired address
	...
	uint32_t AsciiToDecimal(uint16_t starting_index,uint8_t no_of_digits)
	{
		...
		switch(no_of_digits)
		{
			case 1: Decimal_data  = (lineBuffer[starting_index] - 48);
					break;
			...
			case 3: Decimal_data  = (lineBuffer[starting_index] - 48)*100;
					...
					Decimal_data += (lineBuffer[starting_index+2] - 48);
					break;
			case 4: Decimal_data  = (lineBuffer[starting_index] - 48)*1000;
					Decimal_data += (lineBuffer[starting_index+1] - 48)*100;
					Decimal_data += (lineBuffer[starting_index+2] - 48)*10;
					Decimal_data += (lineBuffer[starting_index+3] - 48);
					break;
			default:break;
		}
		return (Decimal_data);
