...
void FLEXCAN_GetDefaultConfig(flexcan_config_t *pConfig)
{
	...
	#else
    pConfig->enableIndividMask    = false;/*added on 10.06.2023 by Rajashekhar to recive all CAN frames on CAN bus*/
	#endif
    pConfig->disableSelfReception = true;
